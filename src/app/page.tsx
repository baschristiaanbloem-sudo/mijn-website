...
const services = [
  ...
  },
  {
    title: "Ouderenzorg",
    description:
      "Zorg op maat voor ouderen, met aandacht voor zelfstandigheid en thuiswonen.",
    icon: (
      <svg className="size-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
  ...
  },
  {
    ...
    description:
      "Medische keuring voor aanvraag of verlenging van uw rijbewijs, op afspraak.",
    icon: (
      <svg className="size-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
  ...
  },
  {
    title: "Vasectomie",
    description:
      "Vaste anticonceptie voor mannen, uitgevoerd in onze behandelkamer na intake.",
    icon: (
      <svg className="size-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
  ...
  },
  {
    title: "Cosmetisch",
    description:
      "Behandeling van huidklachten en cosmetische ingrepen, afgestemd op uw wensen.",
    icon: (
      <svg className="size-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      ...
      <main>
        ...
        >
          ...
          <div className="relative z-10 w-full max-w-xl border border-white/40 bg-white/90 p-8 shadow-xl backdrop-blur-sm md:p-10">
            <p className="text-center text-sm font-medium text-[#8a7a62]">Nieuwe patiënten welkom</p>
            ...
            <p className="mt-6 border-t border-border pt-4 text-center text-sm font-medium text-foreground">
              Vandaag geopend: <span className="text-primary">08:00 – 17:00 uur</span>
            </p>
          </div>
        </section>
          ...
          <div className="mx-auto max-w-6xl px-4 md:px-6">
            ...
            <div className="mt-12 grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
              {services.map((service) => (
                <article
                  key={service.title}
                  className="group bk-card p-6 transition-shadow hover:shadow-md"
                >
          ...
          <div className="mx-auto max-w-3xl px-4 md:px-6">
            <div className="bk-card p-7 md:p-10">
                ...
                <div className="flex flex-col items-center text-center">
                  <span className="flex size-14 items-center justify-center bg-primary text-primary-foreground">
                    ...
                    <p className="mt-2 max-w-md text-sm leading-relaxed text-muted-foreground">
                      Ons online patiëntenportaal voor afspraken, herhaalrecepten en berichten aan
                      de praktijk.
                    </p>
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="bk-btn mt-8 w-full sm:w-auto"
                    >
              ...
              <p className="mt-6 text-center text-sm text-muted-foreground">
                ...
                <a href="tel:0201234567" className="font-medium text-primary hover:underline">
                  020 - 123 45 67
                </a>
                .
              </p>
        ...
        <section id="locatie" className="bg-secondary py-16 md:py-20">
          <div className="mx-auto max-w-6xl px-4 md:px-6">
            <div className="mx-auto max-w-2xl text-center">
              <p className="bk-section-label">Locatie</p>
              <p className="mt-4 text-lg leading-relaxed text-pretty text-muted-foreground">
                U vindt ons aan de {practiceAddress}. Klik op de kaart om de route te openen in
                Google Maps.
              </p>
            </div>
            ...
            <a
              ...
              aria-label={`Open ${practiceAddress} in Google Maps`}
            >
              <div className="relative aspect-[16/9] w-full overflow-hidden md:aspect-[21/9]">
                <iframe
                  title="Kaart met locatie van Bloem & Bloem huisartsen"
